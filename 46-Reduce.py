...
# Imagine que você tem uma colção de dados:
...
A função reduce(), funciona da seguinte forma:
    Passo 1: res1 = f(a1, a2)  # Aplica a função nos dois primeiros elementos da coleção e guarda eo resultado.
    Passo 1: res2 = f(res1, a3)  # Aplica a função passando resultado do paso1 mais o terceiro elemento e guarda o res.
...
# Vamos utilizar a funçao reduce() para multiplicar todos os números de uma lista
