...
Poderiamos chamar este parâmentro de **xis, mas por convenção chamados de **kwargs
...
# OBS: Os nomes da chave em um dicionario devem ser o mesmo dos parâmentos da função
