...
2 - Exemplos NameError -> Ocorre quando uma variável ou função não foi definida.
...
3 - TypeError -> ocorre quando uma função/oepração/açao é aplicada a um tipo errado
...
7- AtributeError -> Ocorre quando uma variável não tem um atributo ou função
