...
print(all([0, 1, 2, 3, 4]))  # Todos os números são verdadeiros? False porque temos o 0
...
# OBS: Um iterável vario convertido em boolean é False mas o all() entende como True
