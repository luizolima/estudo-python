...
zip() -> Cria um iterável (zip object) que agreda elemento de cada um dos iteráveis passados como entrada em pares.
...
# trabalhando com iteráveis de tamanhso diferentes, irá parar quando os elementos do menor
# iterável acabar.
lista3 = [7, 8, 9, 10, 11]
