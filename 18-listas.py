...
# fina; de um elemento está ligado ao início da lista
...
# Outros métodos não tão impostantes mas também úteis
...
lista = [1, 2, 3, 4]
print(lista[1:])  # Iniciando no índice 1 e pegaando todos os elementos restantes
...
ptint(lista[::2])  # Começa em 0, vai até o final de 2 em 2
