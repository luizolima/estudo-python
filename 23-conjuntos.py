...
Diferença entre Conjuntos (set) e Mpaas (Dicionários) em Python:
...
print(f'Dicionário: {dicionario} com {len(dicionario.items())} elementos')
...
# {'Guilherme', 'Pedro', 'Fernando', 'Gustavo', 'Ana', 'Ellen', 'Julia', 'Patricia', 'Marcos'}
# unicos1 = estudantes_java.union(estudantes_python)
# {'Ellen', 'Guilherme', 'Ana', 'Gustavo', 'Pedro', 'Julia', 'Fernando', 'Marcos', 'Patricia'}
print(unicos1)
