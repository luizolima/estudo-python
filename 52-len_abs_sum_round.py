...
abs(0 -> Retorna o  valor absoluto de um número inteiro ou real. De forma básica, seria o seu valor real sem o sinal.
...
incluindo o valor  o valor inicial
...
round() -> Retorna um n~umero arrendondado para n digitos de precisão após a casa decimal. Se a precisão não for
